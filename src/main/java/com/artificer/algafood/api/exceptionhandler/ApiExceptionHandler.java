...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex,
		...
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREESIVEL;
		String detail = String.format("A propriedade '%s' recebeu o valor '%s', que é inválido. Corrija e informe um valor do tipo '%s'","a", ex.getValue(), ex.getTargetType().getSimpleName());
